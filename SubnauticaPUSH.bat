...
:loop
    ...
    if not defined commit_msg (
        ...
        cd C:/Users/mathi/AppData/LocalLow/Unknown Worlds/Subnautica/Subnautica/SavedGames && git add . && git commit -m "%commit_msg%" && git push --set-upstream https://github.com/Malachite01/subnauticaSaves.git master
