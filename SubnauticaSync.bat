...
:loop
    ...
    if not defined commit_msg (
        ...
        cd C:/Users/mathi/AppData/LocalLow/Unknown Worlds/Subnautica/Subnautica/SavedGames && git stash save "%commit_msg%" && git pull --rebase --set-upstream https://github.com/Malachite01/subnauticaSaves.git master && git stash apply && git add . && git commit -m "%commit_msg%" && git push --set-upstream https://github.com/Malachite01/subnauticaSaves.git master
